...
class CmsswPreprocessor :
	...
	def run(self,component,wd,firstEvent,nEvents):
		...
		self.maybePrefetchFiles(component)
                print "--> 001/2",self.configFile, "./"+self.configFile, imp.load_source("cmsRunProcess","./"+self.configFile)
...
#				fn="file:"+fn
		...
		cmsswConfig.process.source.fileNames = inputfiles
                print "A01",hasattr(cmsswConfig.process.source,"secondaryFileNames")
